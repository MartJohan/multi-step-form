...
<template v-if="personalia" >
    <form id="personaliaForm" class="flex flex-col gap-y-4">
        <div class="flex flex-col">
            ...
            <input v-model="name" @input="handleNameChange" type="text" name="formName" minlength="2" maxlength="30"
                class="mt-1 block w-full font-medium text-coolGray rounded" 
        ...
        <div class="flex flex-col">
            ...
            <input v-model="email" @input="handleEmailChange" type="text" name="formEmailAdress" 
            class="mt-1 block w-full font-medium text-coolGray rounded"
        ...
        <div class="flex flex-col">
            ...
            <input v-model="phoneNumber" @input="handlePhoneNumberChange" 
            type="text" name="formPhoneNumber" minlength="8" maxlength="10"
            class="mt-1 block w-full font-medium text-coolGray rounded"
